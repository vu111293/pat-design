...
namespace Fireball.Docking
{
	...
	public class DockPane : UserControl
	{
		...
		public void Activate()
		{
            ...
            try
            {
                //when the active content is changed, need to notify the UI
                if (ActiveContent is DockableWindow)
                {
                    (ActiveContent as DockableWindow).ActivateUpdate();
                }
            }
            catch
            {
        ...
        private void RefreshChanges(bool bPerformLayout)
        {
            ...
            {
                //MessageBox.Show("local2:" + ex.Message + ex.StackTrace);
            }
            ...
            {
                //MessageBox.Show("local3:" + ex.Message + ex.StackTrace);
            }
        }
