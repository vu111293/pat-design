...
namespace Fireball.Docking
{
	...
	public class DockContentHandler : IDisposable
	{
		...
		public void Activate()
		{
			...
			else
			{
				...
				else if (!Form.ContainsFocus)
				{
                    ...
                    //}
                    if(Form.Contains(ActiveWindowControl))
                    {
                        ActiveWindowControl.Focus();
                    }
        ...
        private Control m_activeWindowControl = null;
        internal Control ActiveWindowControl
        {
            get { return m_activeWindowControl; }
            set { m_activeWindowControl = value; }
        }
		...
		internal void SetVisible()
		{
		    ...
		    {
		        //MessageBox.Show("local:"+ ex.Message + ex.StackTrace); 
		    }
