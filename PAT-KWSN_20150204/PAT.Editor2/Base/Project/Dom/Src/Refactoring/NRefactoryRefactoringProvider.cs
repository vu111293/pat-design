...
namespace ICSharpCode.SharpDevelop.Dom.Refactoring
{
	public class NRefactoryRefactoringProvider : RefactoringProvider
	{
		...
		public override string CreateNewFileLikeExisting(string existingFileContent, string codeForNewType)
		{
		    ...
		    IOutputAstVisitor outputVisitor = new CSharpOutputVisitor();// (language == NR.SupportedLanguage.CSharp) ? new CSharpOutputVisitor() : (IOutputAstVisitor)new VBNetOutputVisitor();
		...
		public override DomRegion GetFullCodeRangeForType(string fileContent, IClass type)
		{
            ...
            int eof = NR.Parser.CSharp.Tokens.EOF;// csharp ? NR.Parser.CSharp.Tokens.EOF : NR.Parser.VB.Tokens.EOF;
		    int attribStart = NR.Parser.CSharp.Tokens.OpenSquareBracket;//csharp ? NR.Parser.CSharp.Tokens.OpenSquareBracket : NR.Parser.VB.Tokens.LessThan;
		    int attribEnd = NR.Parser.CSharp.Tokens.CloseSquareBracket;//csharp ? NR.Parser.CSharp.Tokens.CloseSquareBracket : NR.Parser.VB.Tokens.GreaterThan;
