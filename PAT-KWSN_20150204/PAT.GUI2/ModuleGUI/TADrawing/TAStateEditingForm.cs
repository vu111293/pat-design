...
{
    public partial class TAStateEditingForm : Form
    {
        //private const string LTSTabItem = "Timed Automata";

        private TAState StateItem;
        //EditorTabItem TextBox_InvariantTab = new EditorTabItem(LTSTabItem);


        public TAStateEditingForm(TAState stateItem)
        {
            InitializeComponent();
            StateItem = stateItem;
            ...
            CheckBox_IsUrgent.Checked = stateItem.IsUrgent;
        ...
        private void Button_OK_Click(object sender, EventArgs e)
        {
            ...
            StateItem.IsCommitted = CheckBox_Commited.Checked;
            StateItem.IsUrgent = CheckBox_IsUrgent.Checked;
            StateItem.IsError = CheckBox_Error.Checked;
        }

        private void CheckBox_IsUrgent_CheckStateChanged(object sender, EventArgs e)
        {
            if(CheckBox_IsUrgent.Checked)
            {
        ...
        private void CheckBox_Commited_CheckedStateChanged(object sender, EventArgs e)
        {
            ...
            {
                CheckBox_IsUrgent.Checked = false;
            }
        }
    }
}
