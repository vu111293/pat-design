...
{
    public class ILATabItem : EditorTabItem
    {
        ...
        public ILATabItem(string moduleName)
        {
            InitializeComponent();
        ...
        private void contextMenuStrip1_Opening(object sender, CancelEventArgs e)
        {
            ...
            if (this.MenuButton_SetAcceptance.Enabled && this.SelectedItems[0].Item is StateItem)
            {
                if ((this.SelectedItems[0].Item as StateItem).IsCommitted)
                {
        ...
        private void Canvas_CanvasItemSelected(object sender, CanvasItemEventArgs e)
        {
            if (this.Button_AddLink.Checked)
            {
                ...
                {
                    LTSCanvas.CanvasItemData SelectedItem = this.SelectedItems[0];
            ...
            else
            {
                ...
                LTSCanvas.CanvasItemData SelectedItem = e.CanvasItem;
        ...
        private void TreeView_Structure_NodeMouseDoubleClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            ...
            if (e.Node.Parent != null && e.Node.Parent.Text == Parsing.PROCESSES_NODE_NAME)
            {
                ...
                Canvas = (e.Node.Tag as LTSCanvas);
                if (Canvas != null)
                {
                    Canvas.Visible = true;
        ...
        private void MenuButton_Urgent_Click(object sender, EventArgs e)
        {
            ...
            {
                LTSCanvas.CanvasItemData SelectedItem = this.SelectedItems[0];
                StateItem state = SelectedItem.Item as StateItem;
                if(state != null)
                {
        ...
        public override void SetText(string text)
        {
            ...
            foreach (LTSCanvas canvas in lts.Properties)
            {
                canvas.Dock = DockStyle.Fill;
                canvas.ContextMenuStrip = contextMenuStrip1;
                canvas.CanvasItemSelected += new EventHandler<CanvasItemEventArgs>(Canvas_CanvasItemSelected);
        ...
        private XmlDocument GetDoc()
        {
            ...
            List<LTSCanvas> properties = new List<LTSCanvas>();
        ...
        {
            foreach (LTSCanvas.CanvasItemData SelectedItem in this.SelectedItems)
            {
