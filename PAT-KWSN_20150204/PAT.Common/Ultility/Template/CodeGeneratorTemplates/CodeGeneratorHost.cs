...
namespace PAT.Common.Ultility.Template.CodeGeneratorTemplates
{
    [Serializable]
    public class CodeGeneratorHost : ITextTemplatingEngineHost
    {
        ...
        /// </summary>
        private string _fileExtensionValue = ".cpp";
        ...
        public string ResolveParameterValue(string directiveId, string processorName, string parameterName)
        {
            ...
            {
                case "ProjectName":
                    returnValue = Params.ProjectName;
                    break;
                case "Classes":
                    returnValue = Common.Classes.Ultility.Ultility.PPStringList(Params.Classes,"|");
                    break;
                case "Headers":
                    returnValue = Common.Classes.Ultility.Ultility.PPStringList(Params.Headers, "|");
                    break;
                default:
                    break;
            }
