 ...
 * efficient operations on bool functions f: {0,1}^n --> {0,1}.</p>
 * 
 ...
 * Those BDDs must be a bool function that represents the all-true minterm
...
public abstract class BDD {
     ...
     * @see net.sf.javabdd.BDDDomain#set()
     */
    public abstract BDD satOne(BDD var, bool pol);
    ...
    public class BDDIterator { //implements Iterator 
        ...
        protected bool findNextSatisfyingAssignment() {
         ...
         */
        public bool isDontCare(int var) {
         ...
         */
        public bool isDontCare(BDDDomain d) {
            if (nodes == null) return false;
            int[] vars = d.vars();
    ...
    //protected int printdot_rec(PrintStream out, int current, bool[] visited, HashMap map) {
     ...
     */
    public abstract bool equals(BDD that);
    
    /* (non-Javadoc)
     * @see java.lang.Object#equals(java.lang.Object)
     */
    public bool equals(Object o) {
        if (!(o is BDD)) return false;
    ...
    private static void bdd_printset_rec(BDDFactory f, StringBuilder sb, BDD r, int[] set) {
        int n;
        bool first;
    ...
    public class BDDToString {
         ...
         */
        public static BDDToString INSTANCE = new BDDToString();
