...
using IndexOutOfBoundsException=PAT.Common.Classes.LTL2DRA.exception.IndexOutOfBoundsException;
...
public abstract class BDDFactory {
     ...
     * Logical 'and'.
     */
    public static BDDOp and  = new BDDOp(0, "and");
    
    /**
     * Logical 'xor'.
     */
    public static BDDOp xor  = new BDDOp(1, "xor");
    
    /**
     * Logical 'or'.
     */
    public static BDDOp or    = new BDDOp(2, "or");
    
    /**
     * Logical 'nand'.
     */
    public static BDDOp nand  = new BDDOp(3, "nand");
    
    /**
     * Logical 'nor'.
     */
    public static BDDOp nor   = new BDDOp(4, "nor");
    
    /**
     * Logical 'implication'.
     */
    public static BDDOp imp   = new BDDOp(5, "imp");
    
    /**
     * Logical 'bi-implication'.
     */
    public static BDDOp biimp = new BDDOp(6, "biimp");
    
    /**
     * Set difference.
     */
    public static BDDOp diff  = new BDDOp(7, "diff");
    
    /**
     * Less than.
     */
    public static BDDOp less  = new BDDOp(8, "less");
    
    /**
     * Inverse implication.
     */
    public static BDDOp invimp = new BDDOp(9, "invimp");
    ...
    public class BDDOp {
        int id; 
        String name;
        public BDDOp(int id, String name) {
            this.id = id;
            this.name = name;
        }
     ...
     * No reordering.
     */
    public static ReorderMethod REORDER_NONE    = new ReorderMethod(0, "NONE");
    
    /**
     * Reordering using a sliding window of 2.
     */
    public static ReorderMethod REORDER_WIN2    = new ReorderMethod(1, "WIN2");
    
    /**
     * Reordering using a sliding window of 2, iterating until no further
     * progress.
     */
    public static ReorderMethod REORDER_WIN2ITE = new ReorderMethod(2, "WIN2ITE");
    
    /**
     * Reordering using a sliding window of 3.
     */
    public static ReorderMethod REORDER_WIN3    = new ReorderMethod(5, "WIN3");
    
    /**
     * Reordering using a sliding window of 3, iterating until no further
     * progress.
     */
    public static ReorderMethod REORDER_WIN3ITE = new ReorderMethod(6, "WIN3ITE");
     ...
     * but good method.
     */
    public static ReorderMethod REORDER_SIFT    = new ReorderMethod(3, "SIFT");
    
    /**
     * Same as REORDER_SIFT, but the process is repeated until no further
     * progress is done.  Can be extremely slow.
     */
    public static ReorderMethod REORDER_SIFTITE = new ReorderMethod(4, "SIFTITE");
    
    /**
     * Selects a random position for each variable.  Mostly used for debugging
     * purposes.
     */
    public static ReorderMethod REORDER_RANDOM  = new ReorderMethod(7, "RANDOM");
     ...
     */
    public class ReorderMethod {
        int id; 
        String name;
        public ReorderMethod(int id, String name) {
            this.id = id;
            this.name = name;
        }
        /* (non-Javadoc)
     ...
     */
    public abstract void addVarBlock(BDD var, bool fixedp);
     ...
     */
    public abstract void addVarBlock(int first, int last, bool fixedp);
    // TODO: handle error code for addVarBlock.
     ...
     */
    public abstract int nodeCount(Collection<BDD> /*BDD*/ r);
     ...
     * @version $Id: BDDFactory.java,v 1.11 2005/05/04 22:31:35 joewhaley Exp $
     */
    public  class ReorderStats { //static
     ...
     * @version $Id: BDDFactory.java,v 1.11 2005/05/04 22:31:35 joewhaley Exp $
     */
    public class CacheStats { //static
        ...
        public void copyFrom(CacheStats that) {
     ...
     * objects of the correct type.</p>
     */
    public abstract BDDBitVector createBitVector(int a);
     ...
     */
    public BDDBitVector buildVector(int bitnum, bool b) {
    ...
    protected bool unregisterCallback(List callbacks, Object o, Method m) {
        if (callbacks != null) {
