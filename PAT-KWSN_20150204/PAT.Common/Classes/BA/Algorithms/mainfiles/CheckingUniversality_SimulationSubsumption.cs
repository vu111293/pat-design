...
using UniversalityOpt = cav2010.algorithms.UniversalityOpt;
...
namespace cav2010.mainfiles
{
	...
	public class CheckingUniversality_SimulationSubsumption
	{
		...
		public static void  Main(System.String[] args)
		{
			...
			UniversalityOpt inclusion = new UniversalityOpt(aut);
			inclusion.Start();
			try
			{
			...
			else
			{
				...
				System.Console.Out.WriteLine("Time for the Simulation Subsumption algorithm(ms): " + ttime1 / 1000000 + ".");
			}
		}
	}
}